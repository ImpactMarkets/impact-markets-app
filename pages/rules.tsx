...
const RulesAndTerms: NextPageWithAuthAndLayout = () => {
  return (
    <div className="max-w-[720px] mx-auto my-5 py-6">
      ...
      <p className="py-3">
        <strong>Last updated February 14, 2023</strong>
      </p>
      <p className="py-3">
      ...
      <p className="py-1">
        <a href="#thirdparty">11. THIRD-PARTY WEBSITE AND CONTENT</a>
      </p>
      <p className="py-1">
        <a href="#sitemanage">12. SITE MANAGEMENT</a>
      </p>
      <p className="py-1">
        <a href="#privacypolicy2">13. PRIVACY POLICY</a>
      </p>
      <p className="py-1">
        <a href="#copyright2">14. COPYRIGHT INFRINGEMENTS</a>
      </p>
      <p className="py-1">
        <a href="#terms">15. TERM AND TERMINATION</a>
      </p>
      <p className="py-1">
        <a href="#modifications">16. MODIFICATIONS AND INTERRUPTIONS</a>
      </p>
      <p className="py-1">
        <a href="#law">17. GOVERNING LAW</a>
      </p>
      <p className="py-1">
        <a href="#disputes">18. DISPUTE RESOLUTION</a>
      </p>
      <p className="py-1">
      ...
      <p className="py-1">
        <a href="#liability">21. LIMITATIONS OF LIABILITY</a>
      </p>
      <p className="py-1">
        <a href="#indemnification">22. INDEMNIFICATION</a>
      </p>
      <p className="py-1">
        <a href="#userdata">23. USER DATA</a>
      </p>
      <p className="py-1">
        <a href="#electronic">
      ...
      <p className="py-1">
        <a href="#california">25. CALIFORNIA USERS AND RESIDENTS</a>
      </p>
      <p className="py-1">
      ...
      <p className="py-3">1. AGREEMENT TO TERMS</p>
      <p className="py-3">
        ...
        El Cerrito, CA 94530. Our VAT number is EIN 88-2860437. You agree that
      ...
      <p className="py-3">2. INTELLECTUAL PROPERTY RIGHTS</p>
      <p className="py-3">
      ...
      <p className="py-3">3. USER REPRESENTATIONS</p>
      <p className="py-3">
      ...
      <p className="py-3">4. USER REGISTRATION</p>
      <p className="py-3">
      ...
      <p className="py-3">5. PROHIBITED ACTIVITIES</p>
      <p className="py-3">
      ...
      <p className="py-3">As a user of the Site, you agree not to:</p>
      <ol className="list-decimal list-outside m-2 ml-10">
        ...
        <li>
          <p className="py-3">Sell or otherwise transfer your profile.</p>
        </li>
      </ol>
      <p className="py-3">6. USER GENERATED CONTRIBUTIONS</p>
      <p className="py-3">
      ...
      <p className="py-3">7. CONTRIBUTION LICENSE</p>
      <p className="py-3">
      ...
      <p className="py-3">8. GUIDELINES FOR REVIEWS</p>
      <p className="py-3">
      ...
      <p className="py-3">9. SOCIAL MEDIA</p>
      <p className="py-3">
      ...
      <p className="py-3">12. SITE MANAGEMENT</p>
      <p className="py-3">
      ...
      <p className="py-3">13. PRIVACY POLICY</p>
      <p className="py-3">
      ...
      <p className="py-3">14. COPYRIGHT INFRINGEMENTS</p>
      <p className="py-3">
      ...
      <p className="py-3">15. TERM AND TERMINATION</p>
      <p className="py-3">
      ...
      <p className="py-3">16. MODIFICATIONS AND INTERRUPTIONS</p>
      <p className="py-3">
      ...
      <p className="py-3">17. GOVERNING LAW</p>
      <p className="py-3">
      ...
      <p className="py-3">18. DISPUTE RESOLUTION</p>
      <p className="py-3">
      ...
      <p className="py-3">
        ...
        courts located in Erie, New York, and the Parties hereby consent to, and
      ...
      <p className="py-3">19. CORRECTIONS</p>
      <p className="py-3">
      ...
      <p className="py-3">20. DISCLAIMER</p>
      <p className="py-3">
      ...
      <p className="py-3">21. LIMITATIONS OF LIABILITY</p>
      <p className="py-3">
      ...
      <p className="py-3">22. INDEMNIFICATION</p>
      <p className="py-3">
      ...
      <p className="py-3">23. USER DATA</p>
      <p className="py-3">
      ...
      <p className="py-3">25. CALIFORNIA USERS AND RESIDENTS</p>
      <p className="py-3">
      ...
      <p className="py-3">26. MISCELLANEOUS</p>
      <p className="py-3">
      ...
      <p className="py-3">27. CONTACT US</p>
      <p className="py-3">
        In order to resolve a complaint regarding the Site or to receive further
        information regarding use of the Site, please contact us at:
      </p>
      <p>
        <strong>Good Exchange, PBC</strong>
      </p>
      <p>510 El Cerrito Plz</p>
      <p>Unit 311</p>
      <p>
        <strong>El Cerrito, CA 94530</strong>
      </p>
      <p>
