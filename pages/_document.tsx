        ...
        <Head>
          ...
          <script
            dangerouslySetInnerHTML={{
              __html: `
                // You can allow Rollbar to report client-side errors in development by including the client token as an environment variable.
                if ("${browserEnv.NEXT_PUBLIC_ROLLBAR_CLIENT_TOKEN}" != "development") {
                  var _rollbarConfig = {
